...
<div class="p-6 space-y-4">
    ...
    <div class="flex justify-between items-center flex-wrap gap-4">
        <h2 class="text-2xl font-bold text-gray-800">Edit MBTI Type</h2>
        <p class="text-sm text-gray-500 mt-1">Update MBTI type information</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.data-management.mbti.update', $mbti->mbtiID) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
