...
<div class="p-6 space-y-4">
    ...
    <!-- Page Header -->
    <div>
        <h2 class="text-2xl font-bold text-gray-800">Edit Education Level</h2>
        <p class="text-sm text-gray-500 mt-1">Update the details of this education level</p>
    </div>

    <!-- Form -->
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 max-w-md">
        <form action="{{ route('admin.data-management.education-level.update', $level->edulvlID) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" 
                       name="edulvlType" 
                       id="edulvlType" 
                       value="{{ old('edulvlType', $level->edulvlType) }}" 
