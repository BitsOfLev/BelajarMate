...
<div class="container py-4">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Update your blog post</p>
    </div>

    <!-- Warning Box for Flagged Blogs -->
    @if($blog->is_flagged)
        <div class="warning-box">
            <i class="bi bi-exclamation-triangle-fill"></i>
            <div class="warning-box-content">
                <div class="warning-box-title">This blog is pending review</div>
                <div class="warning-box-text">
                    {{ $blog->flag_reason ?? 'Your blog is currently under review by our moderators.' }}
                    You can still edit it, but changes may also require review.
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="info-box">
        ...
        <div class="info-box-content">
            ...
            <div class="info-box-text">
                If you add images or certain words, your updated blog will require admin review before being published.
            </div>
        </div>
    </div>

    <div class="form-container">
        <form action="{{ route('blog.update', $blog->blogID) }}" method="POST" enctype="multipart/form-data" id="blogForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    name="blogTitle" 
                    id="blogTitle" 
                    value="{{ old('blogTitle', $blog->blogTitle) }}" 
                ...
                <select name="categoryID" id="categoryID" required>
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->categoryID }}" 
                                {{ (old('categoryID', $blog->categoryID) == $category->categoryID) ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea 
                    ...
                    required>{{ old('blogContent', $blog->blogContent) }}</textarea>
                <div class="char-counter">
            ...
            @if($blog->blogImg)
                <div class="current-image">
                    ...
                    <img src="{{ asset('storage/'.$blog->blogImg) }}" alt="Current blog image">
                </div>
            @endif
            ...
            <div class="form-group">
                <label for="blogImg" class="form-label">
                    {{ $blog->blogImg ? 'Replace Image' : 'Add Image' }}
                    <span style="color: #6b7280; font-weight: 400;">(Optional - requires review)</span>
                </label>
                <div class="file-input-wrapper">
                    <label for="blogImg" class="file-input-label">
                        <i class="bi bi-cloud-upload"></i>
                        <span>{{ $blog->blogImg ? 'Choose new image' : 'Choose an image' }}</span>
                    </label>
                    <input 
                        type="file" 
                        name="blogImg" 
