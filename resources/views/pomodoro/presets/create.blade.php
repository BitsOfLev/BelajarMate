...
<div class="container py-4">
    ...
    <div class="page-header">
        <h3 class="page-title">Create Pomodoro Preset</h3>
        <p class="page-subtitle">Customize your focus session timings for better productivity</p>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('pomodoro.presets.store') }}" method="POST">
        @csrf
        ...
        <div class="form-container">
            ...
            <div class="form-section">
                ...
                <p class="section-subtitle">Give your preset a memorable name</p>
            ...
            <div class="form-section">
                ...
                <p class="section-subtitle">Configure your work and break durations</p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            class="form-input" 
                            value="{{ old('short_break_minutes', 5) }}" 
                            min="1" 
                            max="30"
                            placeholder="5"
                            required
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            class="form-input" 
                            value="{{ old('long_break_minutes', 15) }}" 
                            min="1" 
                            max="60"
                            placeholder="15"
                            required
